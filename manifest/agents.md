...
- **messages.md** — JSON payloads `u.delivery` (BROADCAST_ORDER, SUBMIT_BID, AWARD_ORDER, UPDATE_STATUS, REPORT_INCIDENT).
- **security.md** — Safety-by-Design, Kill Switch, Proof of Delivery, privacy.
- **extensions.md** — Meta, Risk Premium, handoff, roadmap.

## Key terms
Requester, Provider, Observer, BROADCAST_ORDER, SUBMIT_BID, AWARD_ORDER, ACCEPTED, ARRIVED_PICKUP, IN_TRANSIT, ARRIVED_DROPOFF, DELIVERED, CANCELLED, FROZEN, u.delivery.
